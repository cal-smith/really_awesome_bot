...
module.exports = function(bot){
	bot.listen("help", function (message) {
		...
		if (!help[0]){
			bot.say('I am ' + bot.name + '. Type "' + bot.name + ' commands" to list avliable commands, or "' + bot.name + ' help <command>" for help with specific commands. Visit https://github.com/hansolo669/really_awesome_bot for info about my circuts.');
		} else {
